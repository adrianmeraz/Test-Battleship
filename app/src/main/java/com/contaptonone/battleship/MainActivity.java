...
import com.contaptonone.battleship.basegameutils.BaseGameUtils;
...
/**
 * A minimalistic "game" that shows turn-based
    ...
    public void updateMatch(TurnBasedMatch match) {
        ...
        switch (turnStatus) {
            case TurnBasedMatch.MATCH_TURN_STATUS_MY_TURN:
                mTurnData = TurnProcess.unpersist(mMatch.getData());
                setGameplayUI();
                return;
